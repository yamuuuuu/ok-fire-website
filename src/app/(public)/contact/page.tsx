...
export default function ContactPage() {
  ...
  return <div className="min-h-dvh bg-slate-50">
    ...
    <main className="mx-auto max-w-2xl px-5 pt-9 pb-32 sm:pt-12">
      ...
      {notice ? <ContactForm notice={notice} uploadsEnabled={!!storageConfig()}/> : <section className="mt-8 rounded-2xl border border-slate-200 bg-white p-6"><h2 className="text-xl font-bold">상담 접수를 준비하고 있습니다.</h2><p className="mt-3 text-sm leading-7 text-slate-600">서비스 준비가 끝나면 온라인으로 접수하실 수 있습니다.</p><Link href="/" className="mt-6 inline-flex min-h-12 items-center font-semibold text-red-700">홈으로 돌아가기 →</Link></section>}
    </main>
  </div>;
}
