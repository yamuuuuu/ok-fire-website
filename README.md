...
- canonical·Open Graph·sitemap·robots·LocalBusiness/Organization·Service·BreadcrumbList 구조화 데이터 및 선택형 GA4 이벤트 기반
...
- `PRIVACY_CONTACT_TEXT`: `010-7124-8119` (대표 연락처, 사용자 확인)
...
- `PRIVACY_POLICY_VERSION`: 표시하는 안내의 버전, 현재 `2026-09-20-v2`. 안내 내용이 바뀌면 함께 변경합니다.
